...
namespace TP {
    ...
    struct LinkTunic {
        ...
        uint16_t tunic_top_unk;       // 0x32AE // might be a timer?
        uint16_t tunic_bottom_red;    // 0x32B0
        uint16_t tunic_bottom_green;  // 0x32B2
        uint16_t tunic_bottom_blue;   // 0x32B4
        uint16_t tunic_bottom_unk;    // 0x32B6 // might be a timer?
